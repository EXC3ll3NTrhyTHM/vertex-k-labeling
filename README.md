...
|-----------------------------------------------------------|--------------------------------------------------|
| ![Heuristic accurate MT3,5](graphs/mt3_14_heuristic_accurate.png) | ![Backtracking MT3,5](graphs/mt3_14_backtracking.png) |

*Figure: side-by-side comparison of labelings.  Notice how the optimal backtracking solution squeezes the same uniqueness constraint into fewer labels (smaller *k*). While the feasible heuristic solution is completed in under 2 seconds.*
